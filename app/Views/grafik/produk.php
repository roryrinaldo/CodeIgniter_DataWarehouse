...
<script>
  $(function () {
    // Fungsi untuk memperbarui grafik berdasarkan tahun dan produk yang dipilih
    function updateChart(year, produk) {
      // Ganti URL di bawah ini sesuai dengan URL untuk mengambil data grafik dari server
      var dataURL = '<?= base_url('grafik/getDataProduk/') ?>' + year + '/' + produk;
      ...
      $.ajax({
        ...
        success: function (data) {
            ...
            barChartData.labels = data.produkLabels;
            barChartData.datasets[0].data = data.produkData;
            ...
            produkChart = new Chart(barChartCanvas, {
              type: 'bar',
              data: barChartData,
            ...
            console.log('Grafik diperbarui dengan data tahun: ' + year + ', produk: ' + produk);
        },
    ...
    $('#submit-btn').on('click', function () {
      ...
      updateChart(selectedYear, selectedProduk);
    });
    ...
    // Inisialisasi grafik
    var produkChart = new Chart(barChartCanvas, {
      type: 'bar',
      data: barChartData,
      options: barChartOptions
    });
