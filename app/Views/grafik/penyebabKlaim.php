  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Grafik Penyebab Klaim</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <!-- Year selection -->
            ...
            <div class="col-md-3">
              <div class="form-group">
                <label for="penyebabKlaim">Pilih Penyebab Klaim:</label>
                <select id="penyebabKlaim" class="form-control">
                  <?php foreach ($penyebabKlaims as $penyebabKlaim) : ?>
                    <option value="<?= $penyebabKlaim->id_penyebab_klaim ?>"><?= $penyebabKlaim->penyebab_klaim ?></option>
                  <?php endforeach; ?>
                </select>
              </div>
            </div>
...
<script>
  $(function () {
    // Fungsi untuk memperbarui grafik berdasarkan tahun dan penyebab klaim yang dipilih
    function updateChart(year, penyebabKlaim) {
      // Ganti URL di bawah ini sesuai dengan URL untuk mengambil data grafik dari server
      var dataURL = '<?= base_url('grafik/getDataPenyebabKlaim/') ?>' + year + '/' + penyebabKlaim;
      ...
      $.ajax({
        ...
        success: function (data) {
            ...
            barChartData.labels = data.penyebabKlaimLabels;
            barChartData.datasets[0].data = data.penyebabKlaimData;

            // Jika grafik sudah diinisialisasi sebelumnya, hapus grafik sebelum membuat yang baru
            if (penyebabKlaimChart) {
            penyebabKlaimChart.destroy();
            }

            // Inisialisasi grafik baru
            penyebabKlaimChart = new Chart(barChartCanvas, {
            type: 'bar',
            data: barChartData,
            ...
            console.log('Grafik diperbarui dengan data tahun: ' + year + ', penyebab klaim: ' + penyebabKlaim);
        },
    ...
    $('#submit-btn').on('click', function () {
      ...
      var selectedPenyebabKlaim = $('#penyebabKlaim').val();
      updateChart(selectedYear, selectedPenyebabKlaim);
    });
    ...
    // Inisialisasi grafik
    var penyebabKlaimChart = new Chart(barChartCanvas, {
      type: 'bar',
      data: barChartData,
      options: barChartOptions
    });
