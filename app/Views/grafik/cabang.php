...
<script>
  $(function () {
    // Fungsi untuk memperbarui grafik berdasarkan tahun dan cabang yang dipilih
    function updateChart(year, cabang) {
      // Ganti URL di bawah ini sesuai dengan URL untuk mengambil data grafik dari server
      var dataURL = '<?= base_url('grafik/getDataCabang/') ?>' + year + '/' + cabang;
      ...
      $.ajax({
        ...
        success: function (data) {
            ...
            barChartData.labels = data.cabangLabels;
            barChartData.datasets[0].data = data.cabangData;
            ...
            cabangChart = new Chart(barChartCanvas, {
            type: 'bar',
            data: barChartData,
            ...
            console.log('Grafik diperbarui dengan data tahun: ' + year + ', cabang: ' + cabang);
        },
    ...
    $('#submit-btn').on('click', function () {
      ...
      updateChart(selectedYear, selectedCabang);
    });
    ...
    // Inisialisasi grafik
    var cabangChart = new Chart(barChartCanvas, {
      type: 'bar',
      data: barChartData,
      options: barChartOptions
    });
