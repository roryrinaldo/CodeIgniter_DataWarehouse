  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Grafik Sektor Usaha</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <!-- Year selection -->
            ...
            <div class="col-md-3">
              <div class="form-group">
                <label for="sektorUsaha">Pilih Sektor Usaha:</label>
                <select id="sektorUsaha" class="form-control">
                  <?php foreach ($sektorUsahas as $sektorUsaha) : ?>
                    <option value="<?= $sektorUsaha->id_sektor_usaha ?>"><?= $sektorUsaha->sektor_usaha ?></option>
                  <?php endforeach; ?>
                </select>
              </div>
            </div>
...
<script>
  $(function () {
    // Fungsi untuk memperbarui grafik berdasarkan tahun dan sektor usaha yang dipilih
    function updateChart(year, sektorUsaha) {
      // Ganti URL di bawah ini sesuai dengan URL untuk mengambil data grafik dari server
      var dataURL = '<?= base_url('grafik/getDataSektorUsaha/') ?>' + year + '/' + sektorUsaha;
      ...
      $.ajax({
        ...
        success: function (data) {
            ...
            barChartData.labels = data.sektorUsahaLabels;
            barChartData.datasets[0].data = data.sektorUsahaData;

            // Jika grafik sudah diinisialisasi sebelumnya, hapus grafik sebelum membuat yang baru
            if (sektorUsahaChart) {
            sektorUsahaChart.destroy();
            }

            // Inisialisasi grafik baru
            sektorUsahaChart = new Chart(barChartCanvas, {
            type: 'bar',
            data: barChartData,
            ...
            console.log('Grafik diperbarui dengan data tahun: ' + year + ', sektor usaha: ' + sektorUsaha);
        },
    ...
    $('#submit-btn').on('click', function () {
      ...
      var selectedSektorUsaha = $('#sektorUsaha').val();
      updateChart(selectedYear, selectedSektorUsaha);
    });
    ...
    // Inisialisasi grafik
    var sektorUsahaChart = new Chart(barChartCanvas, {
      type: 'bar',
      data: barChartData,
      options: barChartOptions
    });
